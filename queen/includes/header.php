...
if (basename($_SERVER['PHP_SELF']) !== 'admin.php' && basename($_SERVER['PHP_SELF']) !== 'login.php' && basename($_SERVER['PHP_SELF']) !== 'delete.php' && basename($_SERVER['PHP_SELF']) !== 'update.php' && basename($_SERVER['PHP_SELF']) !== 'insert.php' && basename($_SERVER['PHP_SELF']) !== 'update_tracks.php') {
